...
def MakeFigures():
    resp = Respondents()
    resp.ReadRecords('/Volumes/MichaelWright1/Dropbox/Projects/ThinkStats/ThinkStats/resources',n=1000)
    ...
    resp = Respondents()
    resp.ReadRecords('/Volumes/MichaelWright1/Dropbox/Projects/ThinkStats/ThinkStats/resources',n=10000)
    heights, weights = resp.GetHeightWeight(jitter=1.3)
