...
def MakeFigures():
    ...
    myplot.Clf()
    myplot.Cdf(cdf)
    myplot.Save(root='../resources/plots/populations',
    ...
    myplot.Clf()
    myplot.Cdf(cdf) 
    myplot.Save(root='../resources/plots/populations_logx',
                title='City/Town Populations',
                xlabel='population',
                ylabel='CDF',
                xscale='log',
    ...
    myplot.Save(root='../resources/plots/populations_loglog',
                title='City/Town Populations',
                xlabel='population',
    ...
    t.sort()
    rankit.MakeNormalPlot(t, '../resources/plots/populations_rankit')
