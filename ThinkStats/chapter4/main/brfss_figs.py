...
class Respondents(brfss.Respondents):
    ...
    def MakeFigures(self):
        ...
        weights = [record.wtkg2 for record in self.records
                   if record.wtkg2 != 'NA']
        self.MakeNormalModel(weights, root='../resources/plots/brfss_weight_model')
        rankit.MakeNormalPlot(weights,
                              root='../resources/plots/brfss_weight_normal',
                              title='Adult weight',
                              ylabel='Weight (kg)')
        ...
        self.MakeNormalModel(log_weights, 
                             root='../resources/plots/brfss_weight_log',
                             xmax=xmax,
                             xlabel='adult weight (log kg)',
                             axis=axis)
        rankit.MakeNormalPlot(log_weights, 
                              root='../resources/plots/brfss_weight_lognormal',
                              title='Adult weight',
